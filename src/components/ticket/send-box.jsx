...
const SendBox = () => {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 px-2 bg-custom-gradient flex gap-4 items-center py-8">
      <div className="grow relative">
        ...
        <input
          type="file"
          className="absolute top-1/2 -translate-y-1/2 right-6 opacity-0 w-[10px] "
        />
      </div>

      <button className="flex items-center gap-2 bg-primary active:bg-secondary transition-all duration-150 text-white px-6 py-4 rounded-full font-mona">
